...
if (NOT TARGET Qt5::Help)
    ...
    set(Qt5Help_PRIVATE_INCLUDE_DIRS
        "${_qt5Help_install_prefix}/include/qt/QtHelp/5.15.7"
        "${_qt5Help_install_prefix}/include/qt/QtHelp/5.15.7/QtHelp"
    )
    ...
    macro(_populate_Help_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Help_install_prefix}/lib/qt/plugins/${PLUGIN_LOCATION}")
        _qt5_Help_check_file_exists(${imported_location})
