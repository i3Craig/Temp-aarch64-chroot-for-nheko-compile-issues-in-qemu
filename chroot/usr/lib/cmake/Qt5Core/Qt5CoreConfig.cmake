...
if (NOT TARGET Qt5::Core)
    ...
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.15.7"
        "${_qt5Core_install_prefix}/include/qt/QtCore/5.15.7/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;glib;glibc;posix-libiconv;hijricalendar;icu;inotify;journald;linkat;system-pcre2;poll_ppoll;renameat2;sha3-fast;statx;system-doubleconversion)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;getentropy;gnu-libiconv;iconv;lttng;mimetype-database;poll_poll;poll_pollts;poll_select;slog2;syslog)
