...
#include <memory>
#include "../../../nheko-0.10.2/src/TrayIcon.h"
...
QT_MOC_LITERAL(1, 9, 14), // "setUnreadCount"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 5) // "count"

    },
    "TrayIcon\0setUnreadCount\0\0count"
};
...
void TrayIcon::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setUnreadCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
