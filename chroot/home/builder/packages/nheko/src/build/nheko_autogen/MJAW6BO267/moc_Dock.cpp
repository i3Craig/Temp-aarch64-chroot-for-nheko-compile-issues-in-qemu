...
#include <memory>
#include "../../../nheko-0.10.2/src/dock/Dock.h"
...
QT_MOC_LITERAL(1, 5, 14), // "setUnreadCount"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 5) // "count"

    },
    "Dock\0setUnreadCount\0\0count"
};
...
void Dock::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->setUnreadCount((*reinterpret_cast< const int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
